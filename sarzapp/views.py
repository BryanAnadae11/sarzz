...
def leadership(request):
	return render(request, 'sarzapp/leadership.html')

def home(request):
	return render(request, 'sarzapp/index.html')

def plan(request):
	return HttpResponse("Investment Plans are not available at the moment")
	#return render(request, 'sarzapp/plan.html')

def otherpayment(request):
    return render(request, 'sarzapp/otherpayment.html')


def about(request):
	return render(request, 'sarzapp/company.html')


def career(request):
	return render(request, 'sarzapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('sarzapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'sarzapp/login.html')


def privacy(request):
	return render(request, 'sarzapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'sarzapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('sarzapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('sarzapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
		...
		second_template= render_to_string('sarzapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'sarzapp/register.html', context)
...
def dashboard(request):
	...
	return render(request, 'sarzapp/dashboardtwo.html', context)
...
def admindashboard(request):
	...
	return render(request, 'sarzapp/adminpage.html', context)


def terms(request):
	return render(request, 'sarzapp/terms.html')


def realestate(request):
	return render(request, 'sarzapp/realestate.html')


def crypto(request):
	return render(request, 'sarzapp/crypto.html')


def forex(request):
	return render(request, 'sarzapp/forex.html')


def nft(request):
	return render(request, 'sarzapp/nft.html')


def contact(request):
	return render(request, 'sarzapp/contact.html')


def stocks(request):
	return render(request, 'sarzapp/stocks.html')


def agriculture(request):
	return render(request, 'sarzapp/agriculture.html')


def gold(request):
	return render(request, 'sarzapp/gold.html')


def retirement(request):
	return render(request, 'sarzapp/retirement.html')

@login_required(login_url='signin')
def investmentPlans(request):
	return render(request, 'sarzapp/investmentplans.html')
...
def retirementDeposit(request):
	...
	context= {'form':form}
	return render(request, 'sarzapp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'sarzapp/realestateDepositForm.html', context)
...
def cryptoDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'sarzapp/cryptoDepositForm.html', context)
...
def stocksDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'sarzapp/StocksDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'sarzapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	...
	if price_amount and pay_currency:
		...
		headers={'x-api-key':'MFP5MFG-D9W42RM-KK0F1Y1-XEC56GX', 'Content-Type': 'application/json'}
		...
		template= render_to_string('sarzapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
		plain_message= strip_tags(template)
		...
		context={}
	return render(request, 'sarzapp/deposittwo.html', context)
...
def withdrawal(request):
	...
	context={}
	return render(request, 'sarzapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'sarzapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'sarzapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'sarzapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'sarzapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'sarzapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'sarzapp/referralprofilestwo.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'sarzapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('sarzapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('sarzapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'sarzapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('sarzapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'sarzapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'sarzapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('sarzapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('sarzapp/debitMail.html', {'name':client_username,
	...
	context= {}
	return render(request, 'sarzapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'sarzapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('sarzapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('sarzapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
	...
	return render(request, 'sarzapp/reinvest.html', context)
...
def loan(request):
	...
	return render(request, 'sarzapp/loan.html')
...
def portfolio(request):
	...
	return render(request, 'sarzapp/portfolio.html', context)